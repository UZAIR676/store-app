      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-500 text-sm mt-0.5">{orders?.length || 0} orders placed</p>
          </div>
        </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-800">
                  {["Item", "Order ID", "Date", "Total", "Paid", "Delivered", ""].map((h) => (
              ...
              <tbody>
                {orders.map((order) => (
                  <tr key={order._id} className="border-b border-gray-800/50 hover:bg-gray-800/30 transition-colors">
                    ...
                    <td className="px-5 py-4 text-sm text-gray-400">{order.createdAt.substring(0, 10)}</td>
